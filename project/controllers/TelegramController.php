...
class TelegramController extends Controller
{
	public function index($params = [])
	{
		...
		$tgMessage = $tg->sendMessage('sendMessage', ['chat_id' => $msObject->getChatId(), 'text' => $msObject->getMessage(), 'reply_markup' => json_encode(["inline_keyboard" => [[["text" => "button", "callback_data" => "button"]]], "resize_keyboard" => true, "one_time_keyboard" => true])]);
